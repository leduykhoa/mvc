...
// node ./database/database_structure.js

const fs = require(`fs`);
const pluralize = require(`../pluralize.js`);
const schemaTableFile = `./database/migrations/database_structure.sql`;
const schemaTableFileTrigger = `./database/migrations/database_structure_trigger.sql`;
const dateRunTime = new Date();

let data = fs.readFileSync(`./database/database_structure.json`);
let tableNumber = 0;
let tableListData = [];
// ===================================================================================================================================
