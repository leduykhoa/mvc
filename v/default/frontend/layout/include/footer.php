        ...
        <div class="m-auto md:w-10/12 lg:w-8/12 xl:w-6/12">
            <div class="flex flex-wrap items-center justify-between md:flex-nowrap">
                ...
                <div class="m-auto mt-16 w-10/12 space-y-6 text-center sm:mt-auto sm:w-5/12 sm:text-left">
                    ...
                    <span class="block text-gray-500 dark:text-gray-400">PHP MVC Skeleton base on PHP language</span>

                    <p class="block text-gray-500 dark:text-gray-400">
                        Lê Duy Khoa<br />
                        Mail: <a target="_blank" href="mailto:web.fast.2017@gmail.com" title="web.fast.2017@gmail.com">web.fast.2017@gmail.com</a><br />
                        Skype: leduykhoa060690<br />
                        Mobile: <a target="_blank" href="tel:+84973421508" title="+84973421508">+84973421508</a><br />
                        Telegram: <a target="_blank" href="https://t.me/leduykhoa" title="https://t.me/leduykhoa">https://t.me/leduykhoa</a><br />
                        Website: <a target="_blank" href="https://web-fast.com" title="https://web-fast.com">https://web-fast.com</a><br />
                    </p>
                </div>
            </div>
        </div>
