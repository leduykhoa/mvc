    ...
    <div class="container mx-auto">
        <div class="flex flex-wrap justify-center">
            <div class="w-full px-4">
                <div class="mx-auto max-w-[666px] rounded-md py-10 px-6 dark:bg-dark sm:p-[30px] border bg-dark">
                    <form action="/register-post" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" name="full_name" placeholder="<?php __e('Enter your full name'); ?>" class="form-control w-full capitalize" oninput="this.value=this.value.toLowerCase().split(` `).map((item)=>{console.log(item); return `${item.slice(0,1).toUpperCase()}${item.slice(1)}`}).join(` `)" />
                        </div>
                        <div class="mb-5">
